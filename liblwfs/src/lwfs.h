...
#define ZR_FILE_CONTENT_STR     "lwfs.file."
#define ZR_FILE_CONTENT_STRLEN 15

#define LWFS_OPEN_FD_COUNT "lwfs.open-fd-count"
#define LWFS_INODELK_COUNT "lwfs.inodelk-count"
#define LWFS_ENTRYLK_COUNT "lwfs.entrylk-count"
#define LWFS_POSIXLK_COUNT "lwfs.posixlk-count"
...
/* NOTE: all the miscellaneous flags used by LWFS should be listed here */
typedef enum {
        GF_LK_GETLK = 0,
        GF_LK_SETLK,
        GF_LK_SETLKW,
...
typedef struct _lwfs_ctx lwfs_ctx_t;
