...
gf_stat_from_stat (struct gf_stat *gf_stat, struct stat *stat)
{
	...
	if(stat == NULL){
		gf_log("WEIWEI",GF_LOG_ERROR,"gf_stat_from_stat, stat is NULL!");
		return;
	}
#endif
...
#ifndef IOCTL /* wanghy add */
#ifndef STRIPE /* wanghy add */
#define GF_O_LOV_DELAY_CREATE            0100000000
#endif
#endif
...
#ifndef IOCTL /* wanghy add */
#ifndef STRIPE /* wanghy add */
        XLATE_BIT (flags, gf_flags, O_LOV_DELAY_CREATE);
#endif
#endif
...
#ifndef IOCTL /* wanghy add */
#ifndef STRIPE /* wanghy add */
        XLATE_BIT (gf_flags, flags, O_LOV_DELAY_CREATE);
#endif
#endif
