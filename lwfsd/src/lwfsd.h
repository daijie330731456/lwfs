...
#define DEFAULT_CLIENT_VOLUME_FILE            CONFDIR "/lwfs.vol"
#define DEFAULT_SERVER_VOLUME_FILE            CONFDIR "/lwfsd.vol"
#define DEFAULT_LOG_FILE_DIRECTORY            DATADIR "/log/lwfs"
...
FILE *fetch_spec (lwfs_ctx_t *ctx);
